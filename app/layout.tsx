...
const bodyFont = Noto_Sans({ subsets: ['latin'], variable: '--font-body', display: 'swap' });
const titleFont = Oswald({ subsets: ['latin'], weight: ['500', '700'], variable: '--font-title', display: 'swap' });
