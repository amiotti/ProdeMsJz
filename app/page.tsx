      ...
      <div className="landing-grid">
        <div className="landing-panel landing-main">
          ...
          <p className="landing-copy">
            ...
            automáticamente cuando se cargan los resultados oficiales. Podes crear grupos personalizados para seguir entre tu grupo de amigos.
          </p>
        ...
        <div className="landing-panel landing-side">
          <div className="landing-card-stack">
            ...
            <div className="landing-mini-card">
              <span className="landing-mini-label">Grupos personalizados</span>
              <strong>Armá tu grupo de amigos</strong>
              <small>seguí una tabla de posiciones exclusiva entre ustedes</small>
            </div>
          </div>
        </div>
      </div>
